            ...
            <div className="flex-initial skills-hobbies border-r-2 border-gray-c7">
              ...
              <div className="hobbies">
                ...
                <p>
                  ...
                  Spending Time with my two Children, and Exploring the
                  Outdoors.
                </p>
              </div>
            </div>
                  ...
                  <div className="highlights">
                    <ul className="list-inside list-disc">
                      <li>
                        ...
                        service through Docker Ruby on Rails, Java Spring-Boot
                        and ReactJS
                      </li>
                      <li>
                ...
                <div className="employment mb-4">
                  ...
                  <div className="highlights">
                    <ul className="list-inside list-disc">
                      ...
                      <li>
                        Built and maintained new infrastructures while merging
                        our legacy infrastructure over
                      </li>
                      <li>
                        Brought forth extensive experience developing API's to
                        connect and curate new and existing data through
                        multiple platforms
                      </li>
                      <li>
